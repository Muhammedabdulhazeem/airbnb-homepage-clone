...
const RoomCard = ({room:{imageUrl, roomName, location, hostName, date, cost, rating}, index}) => {
  return (
    <div key={index} className='mb-[2rem]'>
        ...
        <div className='flex flex-col'>
            <div className='flex justify-between items-center px-[10px]'>
                <span className='text-[18px] font-[600] leading-[18px]'>{roomName}</span>
            ...
            <span className='px-[10px]'>{location}</span>
